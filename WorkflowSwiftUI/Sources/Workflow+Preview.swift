...
private struct PreviewView<WorkflowType: Workflow>: NSViewControllerRepresentable where WorkflowType.Rendering: Screen {
    typealias ScreenType = WorkflowType.Rendering
    typealias NSViewControllerType = WorkflowHostingController<ScreenType, WorkflowType.Output>
    ...
    func updateNSViewController(
        _ controller: NSViewControllerType,
        context: Context
    ) {
        let coordinator = context.coordinator
